...
<div class="flex flex-col overflow-auto max-h-dvh">
	...
	<div class="p-2 prose-sm lg:prose-base max-w-3xl self-center">
		...
		<p>
			These Terms of Service (“Terms”, “Terms of Service”, “Terms of Use”) govern your use of our
			website located at <b>quickgamez.com</b>
			(together or individually “Service”) operated by <b>QuickGamez</b>.
		</p>
		<p>
		...
		<p>
			...
			but please let us know by emailing at <b>contact@quickgamez.com</b> so we can try to find a solution.
		...
		<p>
			QuickGamez.com has the right but not the obligation to monitor and edit all Content provided
			by users.
		</p>
		<p>
			In addition, Content found on or through this Service are the property of QuickGamez.com or
		...
		<p>
			...
			functionality are and will remain the exclusive property of QuickGamez.com and its licensors.
		...
		<p>
			...
			submit your claim via email to contact@quickgamez.com, with the subject line: “Copyright
		...
		<p>You can contact our Copyright Agent via email at contact@quickgamez.com.</p>
		<p>12. <b>Error Reporting and Feedback</b></p>
		<p>
			You may provide us either directly at contact@quickgamez.com or via third party sites and
		...
		<p>
			...
			controlled by QuickGamez.com.
		</p>
		<p>
			QuickGamez.com has no control over, and assumes no responsibility for the content, privacy
		...
		<p style="margin-top: 5em; font-size: 0.7em;">
			...
			for
			<b>quickgamez.com</b>
			by <a href="https://policymaker.io">PolicyMaker.io</a> on 2025-05-14.
		</p>
	</div>
	<Footer />
</div>
